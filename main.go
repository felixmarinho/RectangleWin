...
func main() {
	...
	hks := []HotKey{
		...
		(HotKey{id: 5, mod: MOD_SHIFT | MOD_ALT | MOD_CONTROL | MOD_NOREPEAT, vk: w32.VK_LEFT, callback: func() { cycleCornerFuncs(0) }}),
		(HotKey{id: 6, mod: MOD_SHIFT | MOD_ALT | MOD_CONTROL | MOD_NOREPEAT, vk: w32.VK_UP, callback: func() { cycleCornerFuncs(1) }}),
		(HotKey{id: 7, mod: MOD_SHIFT | MOD_ALT | MOD_CONTROL | MOD_NOREPEAT, vk: w32.VK_DOWN, callback: func() { cycleCornerFuncs(2) }}),
		(HotKey{id: 8, mod: MOD_SHIFT | MOD_ALT | MOD_CONTROL | MOD_NOREPEAT, vk: w32.VK_RIGHT, callback: func() { cycleCornerFuncs(3) }}),
		(HotKey{id: 50, mod: MOD_SHIFT | MOD_CONTROL, vk: 0x46 /*F*/, callback: func() {
